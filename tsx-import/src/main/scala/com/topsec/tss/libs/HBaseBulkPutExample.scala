...
object HBaseBulkPutExample {
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setAppName("HBaseBulkPutExample " + tableName + " " + columnFamily).setMaster("local")
    ...
    //主要路径，如果是new Path()则是从hdfs上获取
    conf.addResource("192.168.72.21/core-site.xml")
    conf.addResource("192.168.72.21/hbase-site.xml")
